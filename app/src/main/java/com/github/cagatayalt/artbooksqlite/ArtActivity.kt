package com.github.cagatayalt.artbooksqlite
...
import com.github.cagatayalt.artbooksqlite.databinding.ActivityArtBinding
...
class ArtActivity : AppCompatActivity() {
    ...
    // The below (launchers) must be initialized inside onCreate
    private lateinit var activityResultLauncher: ActivityResultLauncher<Intent>
    // This will be used to go to the Gallery
    ...
    fun save(view: View) {
        ...
        if (selectedBitmap != null && artName.isNotBlank() && artistName.isNotEmpty()) {
